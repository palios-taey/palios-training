...
Template from our internal bake workflow (2026-04-17). Adapted for Spark paths.

Inputs:
- Base:    /home/user/models/Huihui-Qwen3.5-35B-A3B-abliterated
- Delta:   /home/user/training_outputs/phase_combined_v1_tail_v2/final/trainable_weights.safetensors
           (12 tensors — 6 keystone layers × 2 projections, PEFT-prefixed keys)

Output:
- /home/user/models/phase_combined_v1_tail_v2_merged
...
# Operator paths are env-overrideable (de-umbilical: defaults preserve the
# original tail_v2 behavior; override for any Config-B delta with the same keystones).
BASE = Path(os.environ.get("BAKE_BASE", os.environ.get("MODEL_PATH",
            "/home/user/models/Huihui-Qwen3.5-35B-A3B-abliterated")))
TRAINED = Path(os.environ.get("BAKE_DELTA",
            "/home/user/training_outputs/phase_combined_v1_tail_v2/final/trainable_weights.safetensors"))
OUT = Path(os.environ.get("BAKE_OUT",
            "/home/user/models/phase_combined_v1_tail_v2_merged"))
KEYSTONE = json.loads(os.environ.get("KEYSTONE_LAYERS", "[8, 9, 11, 15, 21, 23]"))

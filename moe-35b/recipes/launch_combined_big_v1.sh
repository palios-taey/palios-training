...
export SFT_DIR="${SFT_DIR:-/home/user/training_data/combined_big_v1}"
export CPT_DATA=""
export GENERAL_DIR=""
export MAX_SEQ="${MAX_SEQ:-8192}"                 # phase_combined_v1 packing target 7782

export OUTPUT_DIR="${OUTPUT_DIR:-/home/user/training_outputs/combined_big_v1}"
...
export FROZEN_EXPERTS="${FROZEN_EXPERTS:-/home/user/training_data/phase1_infra/frozen_experts_v3.json}"

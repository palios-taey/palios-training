...
export DPO_DATA="${DPO_DATA:-/home/user/training_data/length_mechanics_v1/length_pairs_with_ref.jsonl}"
...
export OUTPUT_DIR="${OUTPUT_DIR:-/home/user/training_outputs/length_mechanics_v1}"

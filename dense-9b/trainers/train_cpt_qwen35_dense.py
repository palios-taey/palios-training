...
Usage:
    export HF_TOKEN=<your-hugging-face-token>   # needed only to pull gated base models
    python3 train_cpt_qwen35_dense.py \\
        --model /home/user/models/Qwen3.5-9B-Base \\
        --data /var/spark/isma/training/cpt_canonical.jsonl \\
        --output /home/user/training_outputs/cpt_qwen35_9b_v1
"""

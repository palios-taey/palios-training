...
# ── Cell config ──────────────────────────────────────────────────────────
BASE_MODEL=/home/user/models/Qwen3.5-9B-Base
CPT_CKPT=/home/user/training_outputs/cpt_v3_v4_dense_9b/checkpoint-2400-multimodal
...
export OUTPUT_DIR="/home/user/training_outputs/diagnostic_2x2_cell_${CELL}_${LABEL}"
mkdir -p "$OUTPUT_DIR"

...
# Resolve sibling dirs (trainers/) relative to this script's location,
...
# ── Paths ─────────────────────────────────────────────────────────────────
MODEL="${MODEL:-/home/user/training_outputs/cpt_v3_v4_dense_9b/checkpoint-2400-multimodal}"
DATA="${DATA:-/var/spark/isma/training/phase3_sft.jsonl}"
OUTPUT="${OUTPUT:-/home/user/training_outputs/phase3_sft_single_spark_qwen35_9b}"
TRAINER="$SCRIPT_DIR/../trainers/train_recovery_sft_qwen35_dense.py"

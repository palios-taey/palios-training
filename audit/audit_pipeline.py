...
Usage:
  python audit_pipeline.py \\
    --probes ./TAEY_AUDIT_V2.json \\
    --candidate http://CANDIDATE_HOST:8000 \\
    --auditor http://AUDITOR_HOST:8765 \\
    --output ./results/audit_v2/
"""
import asyncio
import json
import os
...
SYSTEM_PROMPT_PATH = os.environ.get("SYSTEM_PROMPT_PATH", "")  # set to your candidate system-prompt file

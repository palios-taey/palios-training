...
This project is indexed by GitNexus as **palios-training** (3185 symbols, 3691 relationships, 34 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
